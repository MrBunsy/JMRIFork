...
public class MarklinMon {
    ...
    public static String displayReply(MarklinReply r){
        ...
        switch (r.getPriority()){
            case MarklinConstants.PRIO_1: sb.append("1, Stop/Go/Short"); break;
            case MarklinConstants.PRIO_2: sb.append("2, Feedback"); break;
            case MarklinConstants.PRIO_3: sb.append("3, Engine Stop"); break;
            case MarklinConstants.PRIO_4: sb.append("4, Engine/accessory command"); break;
        ...
        if(command==MarklinConstants.SYSCOMMANDSTART){
            ...
            switch(r.getCommand()){
                case MarklinConstants.LOCODIRECTION : sb.append("Change of direction " + r.getElement(9));
                                                     break;
                case MarklinConstants.LOCOSPEED    : sb.append("Change of speed " + ((r.getElement(9)&0xff<<8) + (r.getElement(10)&0xff)));
                                                     break;
                case MarklinConstants.LOCOFUNCTION  : sb.append("Function: " + r.getElement(9) + " state: " + r.getElement(10));
                                                     break;
                default : sb.append("Management");
            }
        }
        else if(command>=MarklinConstants.ACCCOMMANDSTART && command<=MarklinConstants.ACCCOMMANDEND){
            sb.append("Accessory");
                switch (r.getElement(9)){
                    case 0x00   : sb.append("Set Thrown"); break;
                    case 0x01   : sb.append("Set Closed"); break;
                    default:     sb.append("Unknown state command " + r.getElement(9));
                }
        }
