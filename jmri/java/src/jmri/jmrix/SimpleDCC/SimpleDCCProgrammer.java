 ...
 */
public class SimpleDCCProgrammer extends AbstractProgrammer {

    private SimpleDCCConnectionMemo memo;

    public SimpleDCCProgrammer(SimpleDCCConnectionMemo memo) {
...
//        return _controller;
//    }
    static Logger log = LoggerFactory.getLogger(SimpleDCCProgrammer.class.getName());
