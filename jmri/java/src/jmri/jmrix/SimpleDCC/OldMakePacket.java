...
/**
 * LUKE TODO - this is designed (as far as I can tell) so a serial stream *is* a DCC stream
 * I want this to take a DCC message and return a message that I will pass over
 * the network to my hardware.  This will basically be DCC message + header
 * 
 * 
 * 
