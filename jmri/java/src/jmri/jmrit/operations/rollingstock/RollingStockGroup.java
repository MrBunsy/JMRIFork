...
public class RollingStockGroup {
	...
	/**
	 * Sets the lead for this group. RollingStock must be part of the group. The rolling stock that make up this group
	 * will have the attributes of the lead. However, the length attribute is the sum of all unit lengths plus the
	 * coupler lengths.
	 * 
	 * @param rs
	 *            lead for this group.
